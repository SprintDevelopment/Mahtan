...
(function ($) {
    ...
    $.fn.imageUploader = function (options) {
        ...
        let defaults = {
            ...
            label: 'برای افزودن تصاویر، کلیک کرده یا تصاویر را کشیده و در این قسمت رها کنید'
        };
        ...
        let createContainer = function () {
            ...
            let $container = $('<div>', {class: 'image-uploader'}),
                ...
                $i = $('<div>', { class: 'ci-cloud-upload file-drop-icon fs-2 mb-3'}).appendTo($textContainer),

                // Create the text and append it to the text container
                $span = $('<span>', {class: 'px-2 text-justify fs-sm', text: plugin.settings.label}).appendTo($textContainer);
