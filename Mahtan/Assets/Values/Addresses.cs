namespace Mahtan.Assets.Values
{
    public class Addresses
    {
        public static string ProductLargeImagesPath = Path.Combine("resources", "img", "product", "large");
        public static string ProductThumbImagesPath = Path.Combine("resources", "img", "product", "thumb");
