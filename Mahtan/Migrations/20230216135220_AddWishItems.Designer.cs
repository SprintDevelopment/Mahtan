...
namespace Mahtan.Migrations
{
    ...
    [Migration("20230216135220_AddWishItems")]
    partial class AddWishItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mahtan.Models.Category", b =>
                {
                    ...
                    b.Property<short?>("ProductSizeId")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("Mahtan.Models.ProductSize", b =>
                {
                    b.Property<short>("ProductSizeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<short>("ProductSizeId"));
            ...
            modelBuilder.Entity("Mahtan.Models.ProductSizeItem", b =>
                {
                    b.Property<short>("ProductSizeItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<short>("ProductSizeItemId"));
                    ...
                    b.HasKey("ProductSizeItemId");

                    b.HasIndex("ProductSizeId");

                    b.ToTable("ProductSizeItems");
                });
            ...
            modelBuilder.Entity("Mahtan.Models.WishItem", b =>
                {
                    b.Property<long>("WishItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("WishItemId"));
            ...
            modelBuilder.Entity("Mahtan.Models.Category", b =>
                {
                    b.HasOne("Mahtan.Models.ProductSize", "ProductSize")
                        .WithMany()
            ...
            modelBuilder.Entity("Mahtan.Models.ProductSizeItem", b =>
                {
                    b.HasOne("Mahtan.Models.ProductSize", null)
                        .WithMany("SizeItems")
                        .HasForeignKey("ProductSizeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
